...
describe("Statistics Generation", () => {
	...
	describe("Schema Statistics", () => {
		...
		it("should have consistent header branding in schemas file", () => {
			const generator = new OpenApiPlaywrightGenerator({
				input: fixtureFile,
				outputTypes: "output.ts",
				outputClient: "client.ts",
			...
			// Schemas file should have @cerios/openapi-to-zod-playwright header (not @cerios/openapi-to-zod)
			expect(schemasOutput).toContain("// Auto-generated by @cerios/openapi-to-zod-playwright");
			expect(schemasOutput).not.toContain("// Auto-generated by @cerios/openapi-to-zod\n");
		});
	});
	...
	describe("Client Statistics", () => {
		it("should include statistics in client file when showStats is true", () => {
			...
			expect(clientFileOutput).toContain("// Generation Statistics:");
		...
		it("should not include statistics in client file when showStats is false", () => {
			...
			expect(clientFileOutput).not.toContain("// Generation Statistics:");
	...
	describe("Service Statistics", () => {
		it("should include statistics in service file when showStats is true", () => {
			...
			expect(serviceFileOutput).toContain("// Generation Statistics:");
		...
		it("should not include statistics in service file when showStats is false", () => {
			...
			expect(serviceFileOutput).not.toContain("// Generation Statistics:");
	...
	describe("Statistics format", () => {
		...
		it("should place statistics before imports", () => {
			...
			const statsIndex = clientFileOutput.indexOf("// Generation Statistics:");
