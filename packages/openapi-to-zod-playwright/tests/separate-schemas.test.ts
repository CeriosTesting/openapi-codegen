...
describe("Separate Schemas Mode", () => {
	...
	describe("Basic functionality", () => {
		...
		it("should have consistent header branding in types file", () => {
			const generator = new OpenApiPlaywrightGenerator({
				input: fixtureFile,
				outputTypes: typesFile,
				outputZodSchemas: schemasFile,
			...
			// Types file should have @cerios/openapi-to-zod-playwright header (not @cerios/openapi-to-typescript)
			expect(typesContent).toContain("// Auto-generated by @cerios/openapi-to-zod-playwright");
			expect(typesContent).not.toContain("// Auto-generated by @cerios/openapi-to-typescript");
		});
