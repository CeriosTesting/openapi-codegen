...
describe("Separate Schemas Mode", () => {
	...
	describe("Basic functionality", () => {
		...
		it("should have consistent header branding in types file", () => {
			...
			// Types file should have @cerios/openapi-to-zod header (not @cerios/openapi-to-typescript)
			expect(typesContent).toContain("// Auto-generated by @cerios/openapi-to-zod");
