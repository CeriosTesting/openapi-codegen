...
describe("OpenApiK6Generator", () => {
	...
	describe("helper methods", () => {
		...
		it("should not include openapi-to-typescript header in schema types", () => {
			const generator = new OpenApiK6Generator({
				input: fixtureFile,
				outputClient: "test-client.ts",
				outputTypes: "test-types.ts",
			...
			// Schema types should NOT have the openapi-to-typescript header
			// because K6 generator adds its own header when combining files
			expect(output).not.toContain("// Auto-generated by @cerios/openapi-to-typescript");
		});
